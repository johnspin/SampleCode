...
public class Motorcycle: Mobile
{
	// constants to define the motorcycle geometry
	// length taken by a motorcycle on the road
	private const double INIT_LENGTH = 15;
	private const double INIT_WIDTH = 2;
	private const double INIT_MAX_SPEED = 7;

	private const double INIT_FRONT_X  =  4;
	private const double INIT_FRONT_Y  =  0;
	private const double INIT_REAR_X   = -4;
	private const double INIT_REAR_Y   =  0;

	private const double INIT_FLTX =  4;
	private const double INIT_FLTY =  2;
	private const double INIT_FRTX =  4;
	private const double INIT_FRTY = -2;

	private const double INIT_RLTX = -2;
	private const double INIT_RLTY =  2;
	private const double INIT_RRTX = -2;
	private const double INIT_RRTY = -2;
	...
	public Motorcycle(double x, double y, Scene scene): base(x, y, INIT_LENGTH, INIT_MAX_SPEED, scene)
	{
	...
	// Rotate the coordinate of the car such that the motorcycle points in
	...
	// Paint the motorcycle to the display using the rotated coordinates.
