...
public class Road: Conduit
{
	// Construct a new Road with incoming Conveyor in,
	// outgoing Conveyor out, and speed limit new_speed_limit.
	public Road(Conveyor cin, Conveyor cout, double new_speed_limit, Scene scene): 
			base(cin, cout, new_speed_limit, scene){}

	public Road(Conveyor cin, Conveyor cout, double new_speed_limit, int new_layer, Scene scene): 
	...
	public Road(double new_in_x, double new_in_y,
